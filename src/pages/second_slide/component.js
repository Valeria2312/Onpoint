  ...
  return (
    <>
      <div className="SecondSlide_title">
        <img className="SecondSlide_title__bg" src={bg} alt="background" />
        <div className="SecondSlide_title__header">
          текст
          <br /> сообщения
        </div>
        <div className="SecondSlide_title__text">
          ...
          sagittis magna. Maecenas tempus, tellus eget condimentum rhoncus, sem
